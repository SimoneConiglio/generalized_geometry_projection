    ...
    def _run(
        ...
        **options: Any,
        ...
        config = MLSSBOConfig(
            ...
            oa_correction=s.oa_correction,
            oa_margin=s.oa_margin,
            oa_bilateral=s.oa_bilateral,
            oa_raa0=s.oa_raa0,
            oa_rel=s.oa_rel,
            oa_rho_grow=s.oa_rho_grow,
            oa_rho_shrink=s.oa_rho_shrink,
            oa_rho_max=s.oa_rho_max,
            oa_time_limit=s.oa_time_limit,
            lip_safety=s.lip_safety,
            lip_mode=s.lip_mode,
            tunnel=s.tunnel,
            per_variable_tr=s.per_variable_tr,
            mv_grow=s.mv_grow,
            mv_shrink=s.mv_shrink,
            mv_min=s.mv_min,
            mv_max=s.mv_max,
            mv_state_path=s.mv_state_path,
